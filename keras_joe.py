...
def create_model():
    ...
    # model_ps_ind_0609_cat = Sequential()
    # model_ps_ind_0609_cat.add(Embedding(4, 2, input_length=1))
    # model_ps_ind_0609_cat.add(Reshape(target_shape=(2,)))
    # models.append(model_ps_ind_0609_cat)
...
for i in [100,200,300]:
    ...
    MODEL_NAME = 'keras_joe_seed{}'.format(i)
    SEED = i
